public class HumpbackFish implements Enemy {
    ...
    public HumpbackFish(AttackStrategy strategy) {
    ...
    public void die() {
        System.out.println("****************************************");
        System.out.println("HumpbackFish died!");
        System.out.println("****************************************");
    ...
    public void damage(float damage) {
        ...
        System.out.println("****************************************");
        System.out.printf("HumpbackFish got damage, life left: %.1f", this.life);
        System.out.println();
        System.out.println("****************************************");
